...
const Sidebar: React.FC<SidebarProps> = ({ onLogout }) => {
  ...
  return (
    <div 
      className={`fixed top-0 left-0 h-full w-64 bg-blue-600
                 border-r border-white/20 backdrop-blur-lg shadow-2xl`}
    >
      {/* Profile Section */}
      <div className="p-6 border-b border-white/20">
        <div className="flex items-center space-x-4">
          <div className="w-12 h-12 rounded-full overflow-hidden ring-2 ring-blue-300 ring-offset-2 ring-offset-blue-600">
